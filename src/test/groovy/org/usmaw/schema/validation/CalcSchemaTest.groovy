...
class CalcSchemaTest extends GroovyTestCase { 
	...
	void testProjectWithForms(){
		def schema = factory.getJsonSchema("v1/schema/structure/project.schema")
		report = schema.validate(JsonLoader.fromString(new File("resources/v1/examples/projects/minimal_project_with_forms.json").text))
	...
	void testBasicDesignObject(){
		def schema = factory.getJsonSchema("v1/schema/structure/structure.schema")
		report = schema.validate(JsonLoader.fromString(new File("resources/v1/examples/designs/empty_pole.json").text))
	...
	void testOneOfEverythingObject(){
		def schema = factory.getJsonSchema("v1/schema/structure/structure.schema")
		report = schema.validate(JsonLoader.fromString(new File("resources/v1/examples/designs/one_of_everything.json").text))
	...
	void testDamagesObject(){
		def schema = factory.getJsonSchema("v1/schema/structure/structure.schema")
		report = schema.validate(JsonLoader.fromString(new File("resources/v1/examples/designs/damages.json").text))
		report.each{ log.info "testOneOfEverythingObject validation report "+it.toString() }
		assertTrue "this instance should be valid against the schema", report.isSuccess()
	}
	...
	void testBisectorObject(){
		def schema = factory.getJsonSchema("v1/schema/structure/structure.schema")
		report = schema.validate(JsonLoader.fromString(new File("resources/v1/examples/designs/bisector.json").text))
		report.each{ log.info "testBisectorObject validation report "+it.toString() }
		assertTrue "this instance should be valid against the schema", report.isSuccess()		
	}
	void testInsulatorObject(){
		def schema = factory.getJsonSchema("v1/schema/structure/structure.schema")
		report = schema.validate(JsonLoader.fromString(new File("resources/v1/examples/designs/insulator.json").text))
	...
	void testWireObject(){
		def schema = factory.getJsonSchema("v1/schema/structure/structure.schema")
		report = schema.validate(JsonLoader.fromString(new File("resources/v1/examples/designs/wire.json").text))
	...
	void testXArmObject(){
		def schema = factory.getJsonSchema("v1/schema/structure/structure.schema")
		report = schema.validate(JsonLoader.fromString(new File("resources/v1/examples/designs/xarm.json").text))
	...
	void testProjectWithGPSObject(){
		def schema = factory.getJsonSchema("v1/schema/structure/project.schema")
		report = schema.validate(JsonLoader.fromString(new File("resources/v1/examples/projects/minimal_project_with_gps.json").text))
		report.each{ log.info "testProjectWithGPSObject validation report "+it.toString() }
		assertTrue "this instance should be valid against the schema", report.isSuccess()		
	}
	...
	void testFullProjectObject(){
		def schema = factory.getJsonSchema("v1/schema/structure/project.schema")
		report = schema.validate(JsonLoader.fromString(new File("resources/v1/examples/projects/full_project.json").text))
	...
	void testMinimalProjectObject(){
		def schema = factory.getJsonSchema("v1/schema/structure/project.schema")
		report = schema.validate(JsonLoader.fromString(new File("resources/v1/examples/projects/minimal_project_no_designs.json").text))
		report.each{ log.info "testMinimalProjectObject validation report "+it.toString() }
		assertTrue "this instance should be valid against the schema", report.isSuccess()		
	}

	void testMultipleProjects(){
		def schema = factory.getJsonSchema("v1/schema/structure/projects.schema")
		report = schema.validate(JsonLoader.fromString(new File("resources/v1/examples/projects/multiple_projects.json").text))
	...
	void testProjectAdditionalProperties() {
		def schema = factory.getJsonSchema("v1/schema/structure/project.schema")
		JSONObject json = JSONObject.fromObject(new File("resources/v1/examples/projects/full_project.json").text)
		...
		json = JSONObject.fromObject(new File("resources/v1/examples/projects/full_project.json").text)
	...
	void testStructureAddidtionalProperties() {
	    ...
	    def schema = factory.getJsonSchema("v1/schema/structure/structure.schema")
	    def oneOfEverythingText = new File("resources/v1/examples/designs/one_of_everything.json").text
	...
	void testLocationImageURLAndLink() {
		def json = JSONObject.fromObject(new File("resources/v1/examples/projects/full_project.json").text)
		...
		def schema = factory.getJsonSchema("v1/schema/structure/location.schema")
